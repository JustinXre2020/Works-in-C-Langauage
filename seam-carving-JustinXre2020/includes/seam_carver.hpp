...
public:
  ...
  int MinThree(int a, int b, int c) const;

  int MinTwo(int a, int b) const;

  void FindMinRow(int**& arr, int& record_row, int col) const;

  void FindMinCol(int**& arr, int& record_col, int row) const;
